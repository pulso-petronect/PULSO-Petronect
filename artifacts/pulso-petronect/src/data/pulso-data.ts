...
export function generateCommunication(segment: string, channel: string, tone: string, objective: string, _opportunityTitle?: string): { subject: string; body: string } {
  const templates = COMMUNICATION_TEMPLATES[segment]?.[objective]?.[tone];
